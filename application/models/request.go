...
func (r *Request) manageStatusTransition(tx *pop.Connection) error {
	...
	e := events.Event{
		...
		Payload: events.Payload{domain.EventPayloadKeyEventData: eventData},
	}
...
func (r *Request) AfterUpdate(tx *pop.Connection) error {
	...
	e := events.Event{
		...
		Payload: events.Payload{domain.EventPayloadKeyEventData: RequestUpdatedEventData{
			RequestID: r.ID,
		}},
	}
...
func (r *Request) AfterCreate(tx *pop.Connection) error {
	...
	e := events.Event{
		...
		Payload: events.Payload{domain.EventPayloadKeyEventData: RequestCreatedEventData{
			RequestID: r.ID,
		}},
	}
