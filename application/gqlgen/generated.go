...
type Mutation {
    ...
    "Bulk create ` + "`" + `MeetingInvite` + "`" + `s and return the updated list of invites for the specified meeting."
    ...
    If the ` + "`" + `Meeting` + "`" + ` is not ` + "`" + `INVITE_ONLY` + "`" + `, no ` + "`" + `MeetingInvite` + "`" + ` is needed and the ` + "`" + `confirmationCode` + "`" + ` may be omitted.
    """
