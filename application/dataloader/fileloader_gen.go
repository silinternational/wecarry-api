...
type FileLoaderConfig struct {
	...
	Fetch func(keys []int) ([]*models.File, []error)
...
func (l *FileLoader) Load(key int) (*models.File, error) {
...
func (l *FileLoader) LoadThunk(key int) func() (*models.File, error) {
	l.mu.Lock()
...
func (l *FileLoader) LoadAll(keys []int) ([]*models.File, []error) {
...
// This method should be used if you want one goroutine to make requests to many
// different data loaders without blocking until the thunk is called.
func (l *FileLoader) LoadAllThunk(keys []int) func() ([]*models.File, []error) {
	results := make([]func() (*models.File, error), len(keys))
	for i, key := range keys {
		results[i] = l.LoadThunk(key)
	}
...
func (l *FileLoader) Prime(key int, value *models.File) bool {
	l.mu.Lock()
	var found bool
...
func (l *FileLoader) Clear(key int) {
	l.mu.Lock()
	delete(l.cache, key)
	l.mu.Unlock()
}

func (l *FileLoader) unsafeSet(key int, value *models.File) {
	if l.cache == nil {
		l.cache = map[int]*models.File{}
	}
	l.cache[key] = value
}
...
func (b *fileLoaderBatch) keyIndex(l *FileLoader, key int) int {
