...
type OrganizationLoaderConfig struct {
	...
	Fetch func(keys []int) ([]*models.Organization, []error)
...
type OrganizationLoader struct {
	...
	cache map[int]*models.Organization
...
func (l *OrganizationLoader) Load(key int) (*models.Organization, error) {
...
func (l *OrganizationLoader) LoadThunk(key int) func() (*models.Organization, error) {
	l.mu.Lock()
...
func (l *OrganizationLoader) LoadAll(keys []int) ([]*models.Organization, []error) {
...
// This method should be used if you want one goroutine to make requests to many
// different data loaders without blocking until the thunk is called.
func (l *OrganizationLoader) LoadAllThunk(keys []int) func() ([]*models.Organization, []error) {
	results := make([]func() (*models.Organization, error), len(keys))
	for i, key := range keys {
		results[i] = l.LoadThunk(key)
	}
...
func (l *OrganizationLoader) Prime(key int, value *models.Organization) bool {
	l.mu.Lock()
	var found bool
...
func (l *OrganizationLoader) Clear(key int) {
	l.mu.Lock()
	delete(l.cache, key)
	l.mu.Unlock()
}

func (l *OrganizationLoader) unsafeSet(key int, value *models.Organization) {
	if l.cache == nil {
		l.cache = map[int]*models.Organization{}
	}
	l.cache[key] = value
}
...
func (b *organizationLoaderBatch) keyIndex(l *OrganizationLoader, key int) int {
