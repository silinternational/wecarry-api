...
--
-- Name: request_committers; Type: TABLE; Schema: public; Owner: wecarry
--
...
ALTER TABLE public.request_committers OWNER TO wecarry;

--
-- Name: request_committers_id_seq; Type: SEQUENCE; Schema: public; Owner: wecarry
--
...
ALTER TABLE public.request_committers_id_seq OWNER TO wecarry;

--
-- Name: request_committers_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: wecarry
--
...
--
-- Name: request_committers id; Type: DEFAULT; Schema: public; Owner: wecarry
--
...
--
-- Name: request_committers request_committers_pkey; Type: CONSTRAINT; Schema: public; Owner: wecarry
--
...
--
-- Name: request_committers request_committers_post_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: wecarry
--
...
--
-- Name: request_committers request_committers_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: wecarry
--
